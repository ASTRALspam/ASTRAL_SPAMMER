...
import string
import emoji as ej
os.system("title ASTRAL SPAMMER V1 ^") 
...
╚═╝░░╚═╝╚═════╝░░░░╚═╝░░░╚═╝░░╚═╝╚═╝░░╚═╝╚══════╝  ╚═════╝░╚═╝░░░░░╚═╝░░╚═╝╚═╝░░░░░╚═╝╚═╝░░░░░╚═╝╚══════╝╚═╝░░╚═╝
        ...
        {Fore.RED} if you can't do it, try to contact the person who gave it to you or sold it to you
        but the original server is here https://discord.gg/AhSZBC7mFM and made by SICKY

                                

                                         {Fore.LIGHTYELLOW_EX}[1] {Fore.RED}Joiner
                                         {Fore.LIGHTYELLOW_EX}[2] {Fore.RED}Spammer
                                         {Fore.LIGHTYELLOW_EX}[3] {Fore.RED}Leaver
                                         {Fore.LIGHTYELLOW_EX}[4] {Fore.RED}Token Checker
                                         {Fore.LIGHTYELLOW_EX}[5] {Fore.RED}Typing Spammer
                                         {Fore.LIGHTYELLOW_EX}[6] {Fore.RED}Reaction
                                         {Fore.LIGHTYELLOW_EX}[7] {Fore.RED}DM Spammer
                                         {Fore.LIGHTYELLOW_EX}[8] {Fore.RED}Friend Spammer
                                         {Fore.LIGHTYELLOW_EX}[9] {Fore.RED}Exit
...
while True:
    ...
    print("")
    print(banner)
    choice = input(f" {Fore.RED}> {Fore.LIGHTRED_EX}Choice Number: ")
